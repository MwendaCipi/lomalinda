...
const defaultAnnouncements = [{ title: "Sabbath worship", text: "Join us every Saturday for worship, fellowship, and a place to belong.", detail: "Our weekly Sabbath gathering is a time for Bible study, worship, prayer, and fellowship across generations.", href: "/calendar?month=all&search=Sabbath", visibility: "public" }, { title: "Midweek Vespers", text: "Pause in the middle of the week for prayer and encouragement online.", detail: "Make space for prayer and spiritual encouragement with the church family during the week.", href: "/calendar?month=all&search=Midweek%20Vespers", visibility: "public" }, { title: "Serve with us", text: "Explore ministries, outreach, and practical ways to care for our community.", detail: "There is a place for every gift. Discover ways to serve through ministries, Evangelism, and Church welfare.", href: "/ministries", visibility: "public" }];
type Announcement = { id?: number; title: string; text: string; detail: string; href: string; visibility: string; expires_at?: string | null };
