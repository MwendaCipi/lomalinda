          ...
          <section className="order-1 rounded-3xl border border-[#dfdbd1] bg-white p-7 shadow-sm sm:p-9 lg:col-span-2">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              {adultResources.map((item) => (
                <article key={item.title} className="flex flex-col justify-between rounded-2xl border border-[#dfdbd1] bg-[#f7f4ee]/60 p-5 transition hover:border-[#b36b3c] hover:bg-white">
                  <div>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <article className="order-first flex flex-col justify-between rounded-2xl border border-[#dfdbd1] bg-[#f7f4ee]/60 p-5 sm:col-span-2">
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-[#617068]">Read this week&apos;s mission story specially written for children.</p>
                </div>
                <a
                ...
                >
                  Read Mission Story <span>&rarr;</span>
                </a>
              </article>
            </div>
          </section>
