...
const comingSabbathMission = {
  sabbathDate: "Coming Sabbath",
  title: "Adventist Mission Reading — East-Central Africa Division",
  summary: "Discover how mission offerings and prayers are supporting new schools, health centers, and community outreach projects across our Division.",
  fullReadingLink: "https://www.adventistmission.org",
};
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                <span className="rounded-full bg-[#b36b3c]/10 px-3.5 py-1 text-xs font-semibold text-[#b36b3c]">
                  🌍 {comingSabbathMission.sabbathDate}
                </span>
                <h2 className="mt-3 text-2xl font-semibold text-[#26352f]">
                  {comingSabbathMission.title}
                </h2>
                <p className="mt-2 max-w-3xl text-sm leading-6 text-[#617068]">
                  {comingSabbathMission.summary}
                </p>
              </div>
              <a
                href={comingSabbathMission.fullReadingLink}
                target="_blank"
                rel="noreferrer"
                className="shrink-0 rounded-full bg-[#b36b3c] px-5 py-2.5 text-xs font-semibold text-white transition hover:bg-[#96552e]"
              >
                Read Mission Spotlight &rarr;
              </a>
            </div>
          </section>
        </div>
