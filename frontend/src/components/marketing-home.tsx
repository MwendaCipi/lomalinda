        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div id="location" className="mt-10 grid gap-10 border-t border-white/10 pt-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <div>
              ...
              <p className="hidden sm:block mt-3 text-sm leading-6 text-white/70">Use the map to find the church grounds and plan your visit.</p>
            </div>
            <ChurchLocation />
          </div>
          <p className="mt-12 border-t border-white/10 pt-5 text-xs text-white/50">&copy; 2026 Loma Linda SDA Church, Meru</p>
        </div>
      </footer>
    </main>
  );
