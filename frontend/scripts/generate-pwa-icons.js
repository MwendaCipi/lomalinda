  ...
  return `
    <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(${safePadding}, ${safePadding})">
        ...
        <text x="${innerW / 2}" y="${innerH * 0.81}" font-family="sans-serif" font-weight="700" font-size="${innerW * 0.055}" fill="#FFFFFF" text-anchor="middle" letter-spacing="0.5">CHURCH LOMA LINDA</text>
...
async function generate() {
  ...
  console.log('SDA Church Loma Linda, Meru PWA Icons updated successfully!');
}
