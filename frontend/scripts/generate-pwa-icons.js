  ...
  return `
    <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(${safePadding}, ${safePadding})">
        ...
        <!-- Short, balanced church identity below the SDA symbol -->
        <text x="${innerW / 2}" y="${innerH * 0.56}" font-family="sans-serif" font-weight="800" font-size="${innerW * 0.082}" fill="#FFFFFF" text-anchor="middle" letter-spacing="0.8">LOMA LINDA</text>
        <text x="${innerW / 2}" y="${innerH * 0.68}" font-family="sans-serif" font-weight="700" font-size="${innerW * 0.065}" fill="#b36b3c" text-anchor="middle" letter-spacing="1">MERU</text>
      </g>
    </svg>
  `;
}
...
async function generate() {
  ...
  console.log('Loma Linda Meru PWA icons updated successfully!');
}
