  ...
  return `
    <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(${safePadding}, ${safePadding})">
        <!-- Inner Accent Circle around SDA Flame Emblem (upper section) -->
        <circle cx="${innerW / 2}" cy="${innerH * 0.36}" r="${innerW * 0.25}" fill="#1d2a25" stroke="#b36b3c" stroke-width="${innerW * 0.015}" opacity="0.9" />
        ...
        <text x="${innerW / 2}" y="${innerH * 0.81}" font-family="sans-serif" font-weight="700" font-size="${innerW * 0.075}" fill="#FFFFFF" text-anchor="middle" letter-spacing="0.5">LOMA LINDA</text>
