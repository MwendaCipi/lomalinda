...
class ResendContributionReceiptView(APIView):
    ...
    def post(self, request):
        ...
        dest_text = ", ".join(sent_destinations) if sent_destinations else "SMS/Email"
        return Response({
            'detail': f'Receipt resent successfully to {dest_text}.',
